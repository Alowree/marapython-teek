...
| Parameter          | Value | Duration (ms) | Notes                               |
| ------------------ | ----- | ------------- | ----------------------------------- |
| `KeyRepeat`        | `2`   | 30 ms         | Fastest setting in System Settings  |
| `KeyRepeat`        | `1`   | 15 ms         | Custom, faster setting via Terminal |
| `InitialKeyRepeat` | `15`  | 225 ms        | Shortest delay in System Settings   |
| `InitialKeyRepeat` | `10`  | 150 ms        | Custom, faster setting via Terminal |
...
- ⇧ + ⌘ + 4, then press the Spacebar: Capture a Specific Window
