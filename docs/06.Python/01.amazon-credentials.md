...
```bash
curl  \
    -H "Amazon-Advertising-API-ClientId: amzn1.application-oa2-client.c73aae635e0644239fd1860292f93785"\
...
Request again and you will receive a success response, formatted as follows:

<<< request_success_formatted.json
