...
- `Ctrl + e`: Scrolls the screen down one line at a time.
- `Ctrl + y`: Scrolls the screen up one line at a time.
...
- `H`: Moves the cursor to the top ("High") line of the screen.
- `M`: Moves the cursor to the middle line of the screen.
- `L`: Moves the cursor to the bottom ("Low") line of the screen.
