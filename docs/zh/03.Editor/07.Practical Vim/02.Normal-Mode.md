...
::: details What's the difference between a line and a paragraph in Markdown files? Aren't they the same thing?

No, they are different. In Markdown, one line is ended by a `<br>` sign, while a paragraph consists of one line or several lines. Therefore, paragraph is a larger unit.
