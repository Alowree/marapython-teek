...
Beginners will easily get confused here. Actually you don't want to use your work email to generate a GPG key, instead you might want to use your personal email to generate a GPG key, which is virtually your digital ID and you might want to generate one sole ID.

Once generated, you GPG key comes in the form of a shredder and a combinator.

The shredder will decompose your confidential files into unreadable files. Encrypted.
The combinator will reassemble the unreadable files into readable files. Decrypted.
...
Because `~/.config/secrets/soundfreaq.tokens` has been encrypted, it is safe to push this token file to your dotfiles repository for cross platform sharing.
