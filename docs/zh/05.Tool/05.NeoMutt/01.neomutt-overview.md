...
- run `brew install isync` to install
- run `which isync` will throw and error "isync not found"
- run `which mbsync` will output the correct binary `opt/homebrew/bin/mbsync`
