...
`git add -u` This command will stage any tracked files you have deleted or modified, but it will completely ignore any new or untracked folders in your directory.
