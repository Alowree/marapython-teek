...
- **`after/`**: A special directory for scripts that need to run _after_ all other plugins have been loaded. This is useful for overriding default plugin settings.
